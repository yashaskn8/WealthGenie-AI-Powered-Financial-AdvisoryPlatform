...
class MetricsCollector {
  constructor() {
    this.counters = {
      ...
      agent_worker_jobs_waiting_for_approval_total: 0,
      agent_mandate_reconciliation_failures_total: 0,
      agent_mandate_reconciliation_binding_conflicts_total: 0,
      agent_worker_jobs_failed_total: 0,
      agent_worker_jobs_cancelled_total: 0,
      agent_worker_jobs_superseded_total: 0,
      agent_worker_jobs_budget_exceeded_total: 0,
      agent_worker_jobs_timed_out_total: 0,
  ...
  getPrometheusFormat() {
    ...
    const workerCounters = [
      ...
      'agent_worker_jobs_waiting_for_approval_total',
      'agent_mandate_reconciliation_failures_total',
      'agent_mandate_reconciliation_binding_conflicts_total',
      'agent_worker_jobs_failed_total',
      'agent_worker_jobs_cancelled_total',
      'agent_worker_jobs_superseded_total',
      'agent_worker_jobs_budget_exceeded_total',
      'agent_worker_jobs_timed_out_total',
