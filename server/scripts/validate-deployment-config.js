...
if (!(browserMongo.index < browserInstall.index
    ...
    && browserPhase3Migration.index < browserModelActivation.index
...
if (!(dbApply.index < secrets.index
    ...
    && cdPhase3Migration.index < appApply.index
...
console.log(`Validated ${deploymentFiles.length} deployment YAML files, ordered Phase 2 and Phase 3 migrations in browser CI and Kind CD, Compose API/worker separation, and worker probes.`);
